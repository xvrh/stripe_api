...
class Schema {
  ...
  @JsonKey(name: r'x-expandableFields')
  final List<String>? expandableFields;

  @JsonKey(name: r'x-resourceId')
  final String? resourceId;

  @JsonKey(name: 'x-stripeBypassValidation')
  final bool? stripeBypassValidation;

  @JsonKey(name: 'x-expansionResources')
  final Schema? expansionResources;
